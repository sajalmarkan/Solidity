...
contract factory {
    CrowdFunding[] public crowdFinding;

    function requesing(address _crowdOwner, string memory _name) public {
        CrowdFunding crowd = new CrowdFunding(_crowdOwner, _name);
        crowdFinding.push(crowd);
    }
}
...
contract CrowdFunding {
    ...
    function withdrawrequest(string memory _reason, uint _amount) public{
        ...
        request1._amount=_amount*10**18;
